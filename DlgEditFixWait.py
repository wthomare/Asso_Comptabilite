...
class DlgEditFixWait(wx.Dialog):
    
    def __init__(self, parent, ID, basicSoftwareFix):
        wx.Dialog.__init__(self, parent, ID, (""), style=wx.RESIZE_BORDER|wx.CAPTION)
        ...
        self._txtTMO = masked.NumCtrl(self, TXT_TWO, value =self._timeout, min=0, max=1000)
