from BasicSoftwareUtils import *
...
class DlgEditLink (wx.Dialog):
    ...
    def __init__(self, parent, ID, pyutLink):
        ...
        wx.Dialog.__init__(self, parent, ID, ("Link Edit"),
        ...
        #labels
        lblCardA = wx.StaticText(self, -1, ("Cardinality"),
            style = wx.ALIGN_LEFT)
        lblRela  = wx.StaticText(self, -1, ("Relationship"),
            style = wx.ALIGN_CENTRE)
        lblCardB = wx.StaticText(self, -1, ("Cardinality"),
        ...
        lblAinB  = wx.StaticText(self, -1, ("A's role in B"),
            style = wx.ALIGN_LEFT)
        lblBinA  = wx.StaticText(self, -1, ("B's role in A"),
            style = wx.ALIGN_RIGHT)
